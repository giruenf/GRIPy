# -*- coding: utf-8 -*-
"""
Created on Mon Jan 11 10:39:04 2016
...
class Panel(wx.Panel):
    def __init__(self, *args, **kwargs):
        ...
        gridsizer.Add(wx.StaticText(self, label="Vp: "), 0, wx.ALIGN_RIGHT)
        gridsizer.Add(self.xselector, 1, wx.EXPAND)
        gridsizer.Add(wx.StaticText(self, label="Vs: "), 0, wx.ALIGN_RIGHT)
        gridsizer.Add(self.yselector, 1, wx.EXPAND)
        gridsizer.Add(wx.StaticText(self, label="Rho: "), 0, wx.ALIGN_RIGHT)
...
class Dialog(wx.Dialog):
    def __init__(self, *args, **kwargs):
        ...
        wletdata = np.sin(np.linspace(0, np.pi))
        wlet = self._OM.new('wlet', wletdata, name='WAVELET1')
        self._OM.add(wlet)
