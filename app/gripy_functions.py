...
from classes.ui import DataMask
...
def register_app_functions():
    FunctionManager.register_function(do_STFT, "Fourier Transform", Log, data_mask=DataMask)
    FunctionManager.register_function(do_CWT, "Wavelet Transform", Log, data_mask=DataMask)
